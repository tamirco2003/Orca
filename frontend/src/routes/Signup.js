            ...
            <div className={classes.main}>
                <Paper className={classes.paper}>
                    <div className={classes.header}>
                        <Typography variant="h5" color="inherit">Sign Up</Typography>
                    </div>
                    ...
                    <form className={classes.form} onSubmit={this.handleSubmit}>
                        ...
                        <Button fullWidth type="submit" variant="contained" color="primary" className={classes.submit}>Sign Up</Button>
                    </form>
                </Paper>
            </div>
        );
